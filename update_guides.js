...
const filePath = 'c:\\Users\\poste 2\\Downloads\\منصة المسافر-20260608T105153Z-3-001\\منصة المسافر\\app\\dashboard\\page.tsx';
...
// Also replace overflow-x-auto combined with heavy blurs
// Wait, the blur was the main cause. We'll leave the scrolling snap as is.
...
content = content.substring(0, startIdx) + guidesContent + content.substring(endIdx);

fs.writeFileSync(filePath, content, 'utf8');

console.log("Guides tab updated successfully and backdrop-blur lag reduced!");
